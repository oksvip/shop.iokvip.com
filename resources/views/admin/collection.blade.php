...
<head>
    ...
    <link href="{{ asset('static/css/colstyle.css') }}" rel="stylesheet" type="text/css">
                    ...
                    <div class="s-content">
                            ...
                            <div class="s-item">
                                ...
                                <div class="s-pic">
                                    <a href="#" class="s-pic-link">
                                        <img src="{{ asset('static/images/0-item_pic.jpg_220x220.jpg') }}"
                        ...
                        <div class="s-item-wrap">
                            <div class="s-item">
                                ...
                                <div class="s-pic">
                                    <a href="#" class="s-pic-link">
                                        <img src="{{ asset('static/images/1-item_pic.jpg_220x220.jpg') }}"
                        ...
                        <div class="s-item-wrap">
                            <div class="s-item">
                                ...
                                <div class="s-pic">
                                    <a href="#" class="s-pic-link">
                                        <img src="{{ asset('static/images/-0-saturn_solar.jpg_220x220.jpg') }}"
