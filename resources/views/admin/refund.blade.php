...
<html>
	...
	<head>
		...
		<link href="{{ asset('static/css/refstyle.css') }}" rel="stylesheet" type="text/css">

		<script src="{{ asset('static/AmazeUI-2.4.2/assets/js/jquery.min.js') }}" type="text/javascript"></script>
		<script src="{{ asset('static/AmazeUI-2.4.2/assets/js/amazeui.js') }}" type="text/javascript"></script>
						...
						<div class="refund-aside">
							<div class="item-pic">
								<a href="#" class="J_MakePoint">
									<img src="{{ asset('static/images/comment.jpg_400x400.jpg') }}" class="itempic">
								</a>
							</div>
						...
						<div class="refund-main">
							...
							<div class="refund-tip">
								<div class="filePic">
									...
									<img src="{{ asset('static/images/image.jpg') }}" alt="">
								</div>
