        ...
        <article class="blog-main">
            ...
            <div class="am-g blog-content">
                <div class="am-u-sm-12">
                    <p>
                        年轻的妹子爱美丽，这是人之常情，但是没有足够的经济实力，面对昂贵奢华的护肤品难免囊中羞涩。不过不用担心，年轻的资本就是，不需要投入太多，却依然有俏丽的脸蛋儿~今天小编就给妹子们准备了炙手可热的百元护肤大礼包，看看有没有自己需要的吧！</p>

                    <strong class="blog-tit"><p>一张毛爷爷<span>丨</span>基础护肤</p></strong>
                    <div class="Row">
                        <li><img src="{{ asset('static/images/blog01.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog02.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog03.jpg') }}"/></li>
                    </div>
                    ...
                    <div class="Row">
                        <li><img src="{{ asset('static/images/blog04.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog05.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog06.jpg') }}"/></li>
                    </div>
                    ...
                    <div class="Row">
                        <li><img src="{{ asset('static/images/blog07.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog08.jpg') }}"/></li>
                        <li><img src="{{ asset('static/images/blog09.jpg') }}"/></li>
                    </div>
...
<div class="footer">
    ...
    <div class="footer-bd">
        <p>
            ...
            <a href="#">联系我们</a>
            <a href="#">网站地图</a>
            <em>© 2015-2025 Hengwang.com 版权所有. 更多模板
...
<script src="{{ asset('static/js/amazeui.ie8polyfill.min.js') }}"></script>
<![endif]-->
