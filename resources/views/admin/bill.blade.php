...
<head>
    ...
    <link href="{{ asset('static/css/blstyle.css') }}" rel="stylesheet" type="text/css">
                                ...
                                <div class="cards-carousel">
                                    <div class="mask">
                                        ...
                                        <div class="bank ng-binding"
                                             style="background-image: url({{ asset('static/images/combo.png') }});">
                                            中国农业银行
                                        </div>
                                        <div class="details">
                                            <a>查看详情</a>
                                ...
                                <div class="cards-details">
                                    <div class="bank-name">
                                        <div class="name fn-left"
                                             style="background-image: url({{ asset('static/images/combo.png') }});"></div>
