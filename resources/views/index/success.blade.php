...
<head>
    ...
    <title>付款成功页面</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('static/AmazeUI-2.4.2/assets/css/amazeui.css') }}"/>
    ...
    <link href="{{ asset('static/css/sustyle.css') }}" rel="stylesheet" type="text/css"/>
