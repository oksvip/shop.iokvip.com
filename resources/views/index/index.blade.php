...
<html>
	...
	<head>
		...
		<link href="{{ asset('static/css/hmstyle.css') }}" rel="stylesheet" type="text/css" />
		<script src="{{ asset('static/AmazeUI-2.4.2/assets/js/jquery.min.js') }}"></script>
		<script src="{{ asset('static/AmazeUI-2.4.2/assets/js/amazeui.min.js') }}"></script>
	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<div class="nav white">
					<div class="logo"><img src="{{ asset('static/images/logo.png') }}" /></div>
					<div class="logoBig">
						<li><img src="{{ asset('static/images/logobig.png') }}" /></li>
					</div>
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="{{ asset('static/images/ad1.jpg') }}" /></a></li>
								<li class="banner2"><a><img src="{{ asset('static/images/ad2.jpg') }}" /></a></li>
								<li class="banner3"><a><img src="{{ asset('static/images/ad3.jpg') }}" /></a></li>
								<li class="banner4"><a><img src="{{ asset('static/images/ad4.jpg') }}" /></a></li>
			...
			<div class="shopNav">
				<div class="slideall">
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/cake.png') }}"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/cookies.png') }}"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/meat.png') }}"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/bamboo.png') }}"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/nut.png') }}"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/candy.png') }}"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/chocolate.png') }}"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/fish.png') }}"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/tea.png') }}"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="{{ asset('static/images/package.png') }}"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="{{ asset('static/images/navsmall.jpg') }}" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="{{ asset('static/images/huismall.jpg') }}" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="{{ asset('static/images/mansmall.jpg') }}" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="{{ asset('static/images/moneysmall.jpg') }}" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="{{ asset('static/images/TJ2.jpg') }}">
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="{{ asset('static/images/TJ.jpg') }}">
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="../person/index.html">
									<img src="{{ asset('static/images/getAvatar.do.jpg') }}">
								</a>
								<em>
                        ...
                        <div class="advTip"><img src="{{ asset('static/images/advTip.jpg') }}"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3">
							<img src="{{ asset('static/images/2016.png') }}">
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain ">
								<img src="{{ asset('static/images/tj.png') }}">
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain ">
								<img src="{{ asset('static/images/tj1.png') }}">
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain ">
								<img src="{{ asset('static/images/tj2.png') }}">
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="{{ asset('static/images/activity1.jpg') }}">
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="{{ asset('static/images/activity2.jpg') }}">
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="{{ asset('static/images/activity3.jpg') }}">
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="{{ asset('static/images/activity.jpg') }}">
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<div class="am-g am-g-fixed floodOne ">
						<div class="am-u-sm-5 am-u-md-3 am-u-lg-4 text-one ">
							<a href="#">
								<div class="outer-con ">
                                  ...
                                  <img src="{{ asset('static/images/act1.png') }} " />
							</a>
						</div>
						<div class="am-u-sm-7 am-u-md-5 am-u-lg-4">
							<div class="text-two">
								...
								<a href="#"><img src="{{ asset('static/images/act2.png') }} " /></a>
							</div>
		             ...
		             <div class="am-u-sm-12 am-u-md-4 ">
						<div class="am-u-sm-3 am-u-md-6 text-three">
							...
							<a href="#"><img src="{{ asset('static/images/act3.png') }} " /></a>
						</div>
                 ...
                 <div class="clear "></div>
					...
					<div class="am-g am-g-fixed floodTwo ">
						...
						<div class="am-u-sm-7 am-u-md-4 am-u-lg-2 text-two">
								...
								<a href="#"><img src="{{ asset('static/images/5.jpg') }}" /></a>
						</div>
					...
					<div class="am-g am-g-fixed flood method3 ">
						<ul class="am-thumbnails ">
							<li>
								<div class="list ">
									<a href="#">
										<img src="{{ asset('static/images/cp.jpg') }}" />
							...
							<li>
								<div class="list ">
									<a href="#">
										<img src="{{ asset('static/images/cp2.jpg') }}" />
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="{{ asset('static/images/no-img_mid_.jpg') }}" /></p>
								<ul class="user_info ">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="{{ asset('static/images/wdsc.png') }} " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="#">
							<span class="chongzhi "><img src="{{ asset('static/images/chongzhi.png') }} " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="{{ asset('static/images/weixin_code_145.png') }} " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script>
			window.jQuery || document.write('<script src="{{ asset('static/basic/js/jquery.min.js') }}"><\/script>');
		</script>
