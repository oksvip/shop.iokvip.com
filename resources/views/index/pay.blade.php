...
<html>
	...
	<head>
		...
		<link href="{{ asset('static/css/cartstyle.css') }}" rel="stylesheet" type="text/css" />

		<link href="{{ asset('static/css/jsstyle.css') }}" rel="stylesheet" type="text/css" />
				...
				<div class="paycont">
                   ...
                   <span class="buy-user">艾迪 </span>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="{{ asset('static/images/wangyin.jpg') }}" />银联<span></span></li>
							<li class="pay qq"><img src="{{ asset('static/images/weizhifu.jpg') }}" />微信<span></span></li>
							<li class="pay taobao"><img src="{{ asset('static/images/zhifubao.jpg') }}" />支付宝<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="{{ asset('static/images/kouhong.jpg_80x80.jpg') }}" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
