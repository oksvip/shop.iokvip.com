...
<head>
    ...
    <link href="{{ asset('static/css/seastyle.css') }}" rel="stylesheet" type="text/css"/>
            ...
            <div class="quick_toggle">
                ...
                <li class="qtitem">
                    ...
                    <div class="mp_qrcode" style="display:none;"><img
                                src="{{ asset('static/images/weixin_code_145.png') }}"/><i class="icon_arrow_white"></i>
                    </div>
                </li>
                <li class="qtitem">
...
<script>
    window.jQuery || document.write('<script src="{{ asset('static/basic/js/jquery-1.9.min.js') }}"><\/script>');
</script>
